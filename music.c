...
SynthParams synthParams[] = {
    {.sustain = 66, .release = 32, .waveform = 0, .transpose = 57, .volume = 99 / 2, .filtType = 0, .filtFreq = 2, .pitchDrop = 83},
    ...
    {.sustain = 0, .release = 64, .waveform = 0, .transpose = 57, .volume = 96 * 2 / 2, .filtType = 1, .filtFreq = 32, .pitchDrop = 0},
